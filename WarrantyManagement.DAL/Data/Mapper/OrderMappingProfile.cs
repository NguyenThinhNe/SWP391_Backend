                ...
                .ForMember(dest => dest.CustomerEmail, opt => opt.MapFrom(src =>
                 ...
                 .ForMember(dest => dest.VIN, opt => opt.MapFrom(src =>
                    src.WarrantyClaim != null && src.WarrantyClaim.CustomerVehicle != null
                        ? src.WarrantyClaim.CustomerVehicle.VIN
                        : string.Empty))
                .ForMember(dest => dest.VehicleName, opt => opt.MapFrom(src =>
                    src.WarrantyClaim != null && src.WarrantyClaim.CustomerVehicle != null
                        ? src.WarrantyClaim.CustomerVehicle.VehicleName
                        : string.Empty))
                .ForMember(dest => dest.Model, opt => opt.MapFrom(src =>
                    src.WarrantyClaim != null && src.WarrantyClaim.CustomerVehicle != null
                        ? src.WarrantyClaim.CustomerVehicle.Model
                        : string.Empty))
                .ForMember(dest => dest.MileAge, opt => opt.MapFrom(src =>
                    src.WarrantyClaim != null && src.WarrantyClaim.CustomerVehicle != null
                        ? src.WarrantyClaim.CustomerVehicle.MileAge
                        : 0))
