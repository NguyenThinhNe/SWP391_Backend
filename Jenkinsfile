pipeline {
    ...
    environment {
        ...
        // Project info
        APP_NAME = 'warranty-management-be'
        RELEASE = '1'
        GITHUB_URL = 'https://github.com/NguyenThinhNe/SWP391_Backend.git'
        GIT_MANIFEST_FILE = "https://github.com/NguyenThinhNe/BE_Manifest.git"
        ...
        stage('Docker Build') {
            steps {
                script {
                    echo "#====================== Docker Build ======================#"
                    // Dockerfile var
                    def dockerfile = "Dockerfile.prod" // Add custom Dockerfile name ex: ./PathToDockerfile/PathToDockerfile/DevDockerfile
        ...
        stage('Docker Test') {
            steps {
                ...
                script {
                    ...
                    def testPort = env.BRANCH_NAME == 'master' ? '9342' : '9455'
                    ...
                    sh """
                        ...
                        curl -f http://localhost:${testPort}/swagger/index.html || exit 1
                        # Clean up
